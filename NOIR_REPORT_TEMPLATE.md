...
*[For UNCONFIRMED findings: "Witness construction requires [computation].
The mathematical argument is: [argument]. Manual verification recommended."]*
...
- Bug class in finding title must be from the taxonomy
